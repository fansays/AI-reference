...
如图\ref{Fig:semantic-net}。
	\begin{figure} [h]
		...
		\subfloat[All men are moral.]{\label{Fig:semantic-net-1}\input{figures/ans-2.8.1-semantic-net.tex}}\vfill
		\subfloat[Every cloud has a silver lining.]{\label{Fig:semantic-net-2}\input{figures/ans-2.8.2-semantic-net.tex}}\vfill
		\subfloat[All branch manager of DEC participate in a profit-sharing plan.]{\label{Fig:semantic-net-3}\input{figures/ans-2.8.3-semantic-net.tex}}
